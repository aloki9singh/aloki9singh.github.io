    ...
    <p></p>
      <div className="max-w-[1000px] p-4 h-full w-full m-auto grid align-content: center sm:grid-cols-2 gap-10 px-4">
        <div>
          ...
          <div className="sm:text-left h-full grid align-center  sm:text-xl  font-bold">
            <p className="pt-8 ">
              Hi, I'm Alok, nice to meet you. Please take a look around. I have
              spent 2000+ hours in coding , solving DSA problems and gained
              experience with various miniprojects and projects during construct
              week. Strongly interested in obtaining a Software Developer
              position to work on enhancing the product experience.What would
              you do if you had a proficient developer available at your
              fingertips?
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-center align-middle sm:justify-end  ">
          <img className="w-50 h-40  rounded-full lg:w-80 lg:h-80 sm:w-80 sm:h-80" src={Profile} alt="" />
        </div>
      </div>
